...
>
> 📌 **提示词怎么写**（画风质感→画面内容→构图镜头 / 引号标文字 / 中英皆可英文更佳）：见同目录 `prompting.md`。
...
- **krea2 默认激活三件套**（8-23 本工作流库当前状态）：`krea2-Cc-天魔-身材:1.00` + `Krea2-realism_engine_v2_轻量:1.00` + `Krea2-滑块-细节PornMaster_Detail_Slider_Krea2_V1:0.70`；其余 8 个（2D动漫/Afterlight/Yoneyama_Mai/gpt anime render/harustyle/25D动漫/asianMix/动漫补丁）默认 inactive
